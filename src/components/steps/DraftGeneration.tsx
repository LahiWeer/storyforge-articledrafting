...
export const DraftGeneration = ({ storyData, onDraftGenerated }: DraftGenerationProps) => {
  ...
  const regenerateHeadline = async () => {
    ...
    try {
      ...
      setIsRegeneratingHeadline(false);
      toast({
        title: "Headline generation failed",
        description: "Please try again or edit the headline manually",
        variant: "destructive",
      });
    }
  };
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="headline" className="text-sm font-medium text-muted-foreground">
              Your AI-generated headline based on focus, goals, and story angle
            </label>
            <Textarea
              id="headline"
              value={tempHeadline}
